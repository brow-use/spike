...
export class AdminAddressLevelTypePage {
  ...
  readonly exportButton = this.page.getByRole('button', { name: 'Export' });
  ...
  async goto() {
    await this.page.goto('https://app.avniproject.org/#/admin/addressLevelType');
  }
}
