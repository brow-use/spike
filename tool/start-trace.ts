...
export const startTrace: Tool = {
  name: 'start_trace',
  description: 'Start recording a Playwright trace for the named session. Always call this before beginning a workflow recording. Captures screenshots, DOM snapshots, and network activity. The trace is flushed to disk incrementally in chunks under output/trace/<name>/ so a mid-run crash loses at most the last few actions.',
  inputSchema: {
    type: 'object',
    properties: {
